...
Noble.prototype.startScanning = function(serviceUuids, allowDuplicates, activeScan, callback) {
  if (this.state !== 'poweredOn') {
    ...
    this._bindings.startScanning(serviceUuids, allowDuplicates, activeScan);
  }
};
